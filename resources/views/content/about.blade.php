  ...
  <div class="container">
    <div class="row vcenter">
      <div class="col-md-6 mb-3">
        ...
        <p class="mb-3">Quisque cursus gravida commodo. Donec eget lectus at felis rutrum rhoncus. Fusce vestibulum
          sagittis suscipit. Integer commodo semper elit, non fermentum ante tincidunt non. Aliquam eu tellus cursus,
          venenatis augue vel, ullamcorper felis. Mauris mollis gravida eros, nec iaculis nisl hendrerit et.
          Suspendisse sapien ligula, blandit sed tortor non, interdum placerat ex.</p>
        <p>Morbi posuere justo at erat viverra, ac hendrerit purus imperdiet. Pellentesque augue ex, aliquet vel orci
          eu, gravida porta augue. Nam scelerisque magna in felis pellentesque, sit amet sollicitudin diam viverra
          suspendisse eu.</p>
      </div><!-- / column -->
      <div class="col-md-6 feature-left">
        <div class="feature block">
          ...
          <h5>CREATIVITY</h5>
          <p>Vivamus ex odio, cursus vitae dolor ut, imperdiet mattis massa. Morbi orci diam, feugiat quis sapien et,
            accumsan mollis nisl.</p>
        </div><!-- feature-block -->
...
<section id="team" class="bg-white">
  <div class="container w50">
    ...
    <div class="spacer">&nbsp;</div>
    <p class="text-center">Suspendisse quis arcu interdum erat blandit ultricies. Aenean sit amet arcu sem. In rhoncus
      mi eros, a dapibus elit dignissim</p>
    <div class="spacer-2x">&nbsp;</div>
  </div>
  <div class="container">
    <div class="row">
...
<div class="container">
  <div id="testimonials" class="dark parallax">
    ...
    <div id="testimonials-carousel" class="owl-carousel carousel-full-nav owl-theme">
      ...
      <div class="block image-block text-center inner-space">
        <img src="images/creator2.jpg" class="testimonial-image circle" alt="">
        <p class="box-description">Quisque tincidunt sodales ante, nec porttitor sem pharetra vitae. Nullam quis dui
          sit amet lectus facilisis iaculis pulvinar vitae.</p>
